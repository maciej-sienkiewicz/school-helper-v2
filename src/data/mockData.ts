...
export const mockExternalMaterials: ExternalMaterial[] = [
  ...
  },
  {
    ...
    city: 'Wieliczka',
    teacherInitials: 'K.N.',
    teacherName: 'Krzysztof Nowak',
    sharedAt: '2026-03-05',
    likes: 67,
    views: 534,
    comments: [
      { id: 'c2a', text: 'Bardzo przejrzyste zestawienie reguł!', timestamp: '2026-03-06T08:30:00Z' },
    ],
  ...
  },
  {
    id: 'em5',
    subject: 'Matematyka',
    topicName: 'Układy równań – metoda podstawiania',
    unitName: 'Wyrażenia algebraiczne',
    type: 'note',
    scope: 'all',
    schoolName: 'ZSP nr 2',
  ...
  },
  {
    id: 'em6',
    subject: 'Matematyka',
    topicName: 'Twierdzenie Pitagorasa – zadania',
    unitName: 'Geometria płaska',
    type: 'both',
    scope: 'voivodeship',
    schoolName: 'SP nr 21',
    city: 'Wrocław',
    teacherInitials: 'J.K.',
    teacherName: 'Joanna Kamińska',
    sharedAt: '2026-03-12',
    likes: 178,
    views: 1620,
    comments: [
      { id: 'c6a', text: 'Zadania z rozwiązaniami – to jest dokładnie to czego szukałam!', timestamp: '2026-03-13T17:00:00Z' },
    ],
    ...
    recordingDurationSeconds: 2100,
    thumbnailColor: '#a7f3d0',
  },
  {
    id: 'em7',
    subject: 'Matematyka',
    topicName: 'Statystyka – średnia, mediana, dominanta',
    unitName: 'Statystyka i prawdopodobieństwo',
    type: 'recording',
    scope: 'county',
    schoolName: 'SP nr 5 im. T. Kościuszki',
    city: 'Oświęcim',
    teacherInitials: 'E.W.',
    teacherName: 'Ewa Wróbel',
    sharedAt: '2026-03-08',
    likes: 93,
    views: 870,
    comments: [
    ...
    recordingDurationSeconds: 1740,
    thumbnailColor: '#c7d2fe',
  },
];
