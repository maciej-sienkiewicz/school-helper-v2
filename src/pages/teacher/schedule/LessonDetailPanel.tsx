...
import {
  ...
  FileText, Mic, CheckCircle2, Share2, Plus, Edit3, MousePointerClick, X,
} from 'lucide-react';
...
export function LessonDetailPanel({ topic, status, engagement, cls, onClose, onOpenAddMaterial }: Props) {
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 shadow-card flex flex-col overflow-hidden h-full">
                ...
                {TABS.map(({ id, label, icon: Icon }) => {
                  ...
                  return (
                    <button
                      key={id}
                      onClick={() => setTab(id)}
                      className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-1.5 rounded-xl text-xs font-semibold transition-all cursor-pointer ${active ? 'bg-white text-violet-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-3 gap-2">
                        <div className="p-3 rounded-2xl bg-gray-50 text-center">
                          ...
                          <div className="text-[11px] text-gray-500 mt-0.5 leading-tight">Uczniów łącznie</div>
                        </div>
                        <div className="p-3 rounded-2xl bg-violet-50 text-center">
                          ...
                          <div className="text-[11px] text-violet-500 mt-0.5 leading-tight">Otworzyło notatkę</div>
                        </div>
                        <div className="p-3 rounded-2xl bg-amber-50 text-center">
                          ...
                          <div className="text-[11px] text-amber-500 mt-0.5 leading-tight">Odsłuchało nagranie</div>
                        </div>
                      </div>
